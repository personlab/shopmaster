async function fetchEthereumPrice() {
	try {
			...
			const changeElement = document.getElementById('ethereum-menu-change');
			...
			document.getElementById('ethereum-price').textContent = 'Ошибка загрузки цены';
			document.getElementById('ethereum-menu-change').textContent = '';
	}
}
